...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function buildFileGraph(timeline, git, subruns, ledger) {
		...
		function GraphView(props) {
			const { timeline, gitData, subruns, ledger, openFile, runScript, t } = props;
			...
			const graph = React.useMemo(() => {
				const g = buildFileGraph(timeline, gitData, subruns, ledger);
			...
			}, [timeline, gitData, subruns, ledger, shelfOpen]);
		...
		function NodeInspector(props) {
			...
			const meta = [];
			if (node.producedBy !== null) {
				meta.push(React.createElement("div", { key: "pb" }, t("rb.producedBy") + "：", React.createElement("b", null, "▶ " + basename(node.producedBy.scriptPath)), "（" + t("rb.turn") + " " + node.producedBy.turnNum + "）"));
		...
		function RunbookView(props) {
			...
			return React.createElement("div", { className: "rb-root" },
				...
				React.createElement(GraphView, { timeline, gitData, subruns, ledger, openFile, runScript, t }),
			);
		}
