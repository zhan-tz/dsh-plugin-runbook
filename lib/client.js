		...
		function GraphView(props) {
			...
			for (const edge of graph.edges) {
				...
				edgeEls.push(React.createElement("path", {
					...
					strokeWidth: edge.kind === "flow" ? 2.4 : edge.kind === "produce" ? 2.2 : (edge.kind === "attach" || edge.kind === "gitfile") ? 1.2 : undefined,
			...
			return React.createElement(React.Fragment, null,
				React.createElement("div", {
					...
					React.createElement("div", { key: "rb-legend", className: "rb-legend" },
						...
						React.createElement("span", { className: "rb-legend-item" }, React.createElement("span", { className: "rb-legend-line", style: { borderColor: "var(--dsw-alias-border-l2)", borderStyle: "dotted" } }), t("rb.lgAttach")),
					),
