		...
		const artifactDefinition = {
			...
			buildLocationData: (context, scope) => {
				try {
					...
					return { kind: "turn", turn: s.turn, key: "runbook-artifacts", value: { files: s.files, reads: s.reads, activity: s.activity, runs: s.runs, pendingBash: s.pendingBash, model: s.model } };
				} catch {
					return null;
				}
			},
