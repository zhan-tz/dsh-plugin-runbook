	...
	factory: (require) => {
		...
		function StageView(props) {
			...
			return React.createElement("div", { ref: stageRef, className: "rb-stage", style: { cursor: dragRef.current !== null ? "grabbing" : "grab" },
				...
				React.createElement("div", { className: "rb-pipe-badge" }, "📖 ", t("rb.pipeBadge"), " · ", pipeline.nodes.length, " ", t("rb.stages")),
				React.createElement("div", { style: { position: "absolute", left: view.x, top: view.y, transform: "scale(" + view.scale + ")", transformOrigin: "0 0" } },
					React.createElement("svg", { width: laid.width, height: laid.height, style: { display: "block", overflow: "visible" } },
						...
						laid.stages.map((b) => React.createElement("g", { key: b.id },
							...
							React.createElement("text", { x: b.x + b.w - 20, y: b.y + 20, className: "rb-node-stage-status" }, b.stage.status || ""),
						)),
		...
		function RunbookView(props) {
			...
			const gitData = useGitLedger(cwd, fallbackDir);
			const ledger = useLedger(fallbackDir, timeline, props.sessionId);
			const scan = useScan(fallbackDir, gitData);
			const pipeline = usePipeline(fallbackDir, gitData);
			...
			return React.createElement("div", { className: "rb-root" },
				...
				pipeline !== null && pipeline.found === true && Array.isArray(pipeline.nodes) && pipeline.nodes.length >= 3
					? React.createElement(StageView, { pipeline, graph: graphForStage, openFile, runScript, t })
